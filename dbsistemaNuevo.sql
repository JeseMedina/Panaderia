...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-09-2022 a las 00:18:25
...
INSERT INTO `articulo` (`idarticulo`, `idcategoria`, `codigo`, `nombre`, `stock`, `uMedida`, `precioCosto`, `condicion`) VALUES
...
--
ALTER TABLE `usuario_permiso`
  MODIFY `idusuario_permiso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
