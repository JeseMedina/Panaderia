...
Class Venta
{
    ...
    {
        $sql="SELECT dv.idventa,dv.idproducto,a.nombre,dv.cantidad,a.uMedida,dv.precio_venta,dv.descuento,(dv.cantidad*dv.precio_venta-dv.descuento) as subtotal FROM detalle_venta dv inner join producto a on dv.idproducto=a.idproducto where dv.idventa='$idventa'";
        return ejecutarConsulta($sql);
    }
